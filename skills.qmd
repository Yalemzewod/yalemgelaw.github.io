...
With over seven years of academic and research experience, Yalemzewod
has developed a comprehensive skill set in data science and data
analysis. He is proficient in using *R* programming language, Query
language (MySQL, PostgreSQL,and SQL server); visualization tool
(PowerBI) and snowflakes data warehouse. His expertise includes data
managemen and statistical modeling, analytic, systematic and
strategical skills. He also had enough experience in providing
training, University teaching and research supervision. He holds a
master's and PhD in Epidemiology and Biostatistics.
------------------------------------------------------------------------
...
- Lead authored two manuscripts, which are currently prepared for submission to high-impact journals.  - Collaborated with colleagues to develop a training manual on spatial analysis in R and QGIS, and successfully conducted two rounds of training in Ethiopia. 
